...
3. Copier tous les templates d'interfaces depuis `php/skills/make-contracts/templates/Contracts/` vers `src/Contracts/`
...
- Toutes les autres skills du plugin dépendent de ces interfaces
