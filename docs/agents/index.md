...
| `symfony/security-auditor` | [symfony](/plugins/symfony) | Auditeur de securite Symfony : analyse la configuration security, les firewalls, l'authentification, l'autorisation, le CSRF et les vulnerabilites courantes. | Read, Grep, Glob, Bash |
| `symfony/symfony-expert` | [symfony](/plugins/symfony) | Expert generaliste Symfony couvrant le framework core et l'ensemble de l'ecosysteme officiel (150+ bundles). Repond aux questions d'architecture, bonnes pratiques, patterns et integration de composants. | Read, Grep, Glob, Bash |
